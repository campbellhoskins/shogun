...
<main>
  ...
  <div id="right-panel">
    <div id="panel-scenarios">
      ...
      <div class="scenario-empty" id="scenario-hint">Each scenario traces real edges in the knowledge graph built from a travel duty-of-care policy.<br><br>Select a scenario to watch the AI agent traverse the graph step by step.</div>
    </div>
    <div id="panel-active">
